        ...
        <div class="">
        	...
        	<ul class="side-nav">
				...
				<li class="heading">Trending</li>  				
  				...
  				<li><a href="#"><i class="fa fa-search"></i> | Students Search</a></li>
				<li><a href="http://students.iitm.ac.in/swiki/"><i class="fa fa-comments"></i> | Swiki</a></li>  				
  				<br>
  				<li class="heading">Mess Operations</li>  				
  				<li><a href="#"><i class="fa fa-cutlery"></i> | Mess Registration</a></li>
  				<li><a href="#"><i class="fa fa-star-half-o"></i> | Mess Rating</a></li>
			</ul>
