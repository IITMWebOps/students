...
$query_pages = "SELECT DISTINCT name,link,content,trash 
		  ...
		  LIMIT ".($limit_f-$count_students_result[0]-$count_applications_result[0]).", 10";
...
$query_applications = "SELECT DISTINCT name,link 
		  ...
		  LIMIT ".($limit_f-$count_pages_result[0]).", ". (10-$count_pages_result[0]);
...
$query_students = "SELECT DISTINCT username,fullname,room,hostel,contact 
		  ...
		  LIMIT ".$limit_f.", ".(10-$count_pages_result[0]-$count_applications_result[0]);
